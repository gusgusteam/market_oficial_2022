                ...
                <div class="card-body">
                    <form action="{{ route('calzado.update', ['id' => $calzado->id]) }}" method="post"
                        ...
                        <div class="md-form form-group col-12">
                            ...
                            <small id="helpId" class="text-muted">Escriba un codigo de Producto (Campo Obligatorio)</small>
                        ...
                        <div class="form-group col-12">
                            ...
                            <small id="helpId" class="text-muted">Seleccione un Tipo de Producto (Campo Obligatorio)</small>
                        </div>
